...
<ul className="changelog-list">
  <li>
    <strong>FloatingLabelInput component</strong> (<a href="/?path=/docs/components-floating-label-input--docs">FloatingLabelInput</a>)<br/>
  ...
  <li>
    <strong>ProgressSteps component</strong> (<a href="/?path=/docs/components-progress-steps--docs">ProgressSteps</a>)<br/>
