...
const FALLBACK_BREAKPOINTS: Record<PlexUI.Breakpoint, number> = {
  "xs": 380,
  "sm": 576,
  "md": 768,
  "lg": 1024,
...
const resolveBreakpoint = (bp: PlexUI.Breakpoint): number => {
  if (!cache.has(bp)) {
      ...
      if (isDev) {
        ...
        console.warn(
          `--breakpoint-${bp} is not defined in :root. Falling back to default breakpoint map.\n` +
            "This usually means your postcss breakpoints and PlexUI.Breakpoint types are out of sync.",
        )
      }
...
export const useBreakpoint = (bp: PlexUI.Breakpoint): boolean =>
