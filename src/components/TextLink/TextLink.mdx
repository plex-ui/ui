...
<CollapsibleCanvas of={TextLinkStories.Base} />
<CollapsibleSource of={TextLinkStories.Base} />
...
<CollapsibleCanvas of={TextLinkStories.Colors} />
<div className="canvas-controls-only">
<Controls of={TextLinkStories.Colors}/>
</div>
<CollapsibleSource of={TextLinkStories.Colors} />
...
<CollapsibleCanvas of={TextLinkStories.Primary} />
<div className="canvas-controls-only">
<Controls of={TextLinkStories.Primary}/>
</div>
<CollapsibleSource of={TextLinkStories.Primary} />
...
<CollapsibleCanvas of={TextLinkStories.Underline} />
<div className="canvas-controls-only">
<Controls of={TextLinkStories.Underline}/>
</div>
<CollapsibleSource of={TextLinkStories.Underline} />
...
<CollapsibleCanvas of={TextLinkStories.External} />
<CollapsibleSource of={TextLinkStories.External} />

### Font weight
To customize the font weight, pass a Tailwind class to the `className` prop.

<CollapsibleCanvas of={TextLinkStories.Weight} />
<CollapsibleSource of={TextLinkStories.Weight} />
