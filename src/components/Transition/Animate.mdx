...
<div className="story-example">
  <CollapsibleCanvas of={AnimateStories.Fade} />
...
<div className="story-example">
  <CollapsibleCanvas of={AnimateStories.Grow} />
  <CollapsibleSource code={`
<Animate
...
<div className="story-example">
  <CollapsibleCanvas of={AnimateStories.Continuous} />
  <CollapsibleSource code={`
<Animate
  className="w-[200px] h-[200px]"
...
<CollapsibleCanvas of={AnimateStories.CrossFade} />
<CollapsibleSource code={`
