import { Controls, Meta, Subtitle, Title, ArgTypes } from "@storybook/blocks"
...
<div className="story-example">
  <CollapsibleCanvas of={AnimateLayoutStories.SimpleHeight} />
  <CollapsibleSource code={`
<>
...
<div className="story-example">
  <CollapsibleCanvas of={AnimateLayoutStories.SimpleWidth} />
  <CollapsibleSource code={`
<div className="flex">
...
<CollapsibleCanvas of={AnimateLayoutStories.Accordion} layout="padded" />
<CollapsibleSource code={`
<AnimateLayout
...
<CollapsibleCanvas of={AnimateLayoutStories.TalkButton} />
<CollapsibleSource code={`
<Button
