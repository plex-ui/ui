...
<CollapsibleCanvas of={MenuStories.Base} />
<CollapsibleSource of={MenuStories.Base} />
...
<CollapsibleCanvas of={MenuStories.NaturalSizing} />
<CollapsibleSource of={MenuStories.NaturalSizing} />

### Submenus

Use `Menu.Sub`, `Menu.SubTrigger`, and `Menu.SubContent` to create nested menu items.

<CollapsibleCanvas of={MenuStories.WithSubmenu} />
<CollapsibleSource of={MenuStories.WithSubmenu} />
...
<CollapsibleCanvas of={MenuStories.WithCheckboxes} />
<div className="canvas-controls-only">
<Controls of={MenuStories.WithCheckboxes}/>
</div>
<CollapsibleSource of={MenuStories.WithCheckboxes} />
...
<CollapsibleCanvas of={MenuStories.WithRadioItems} />
<div className="canvas-controls-only">
<Controls of={MenuStories.WithRadioItems}/>
</div>
<CollapsibleSource of={MenuStories.WithRadioItems} />
...
<CollapsibleCanvas of={MenuStories.ItemActions} />
<CollapsibleSource of={MenuStories.ItemActions} />
