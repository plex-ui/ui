...
<CollapsibleCanvas of={AvatarStories.Base} additionalActions={[
  { title: 'View story', onClick: linkTo(AvatarStories.title, 'Base')}
]} />
<CollapsibleSource of={AvatarStories.Base} />
...
<CollapsibleCanvas of={AvatarStories.Text} />
<CollapsibleSource of={AvatarStories.Text} />
...
<CollapsibleCanvas of={AvatarStories.Image} />
<CollapsibleSource of={AvatarStories.Image} />
...
<CollapsibleCanvas of={AvatarStories.Icon} />
<CollapsibleSource code={`<Avatar
  Icon={Robot}
  size={48}
/>`} />
...
<CollapsibleCanvas of={AvatarStories.Overflow} />
<CollapsibleSource of={AvatarStories.Overflow} />
...
<CollapsibleCanvas of={AvatarStories.Interactive} />
<CollapsibleSource code={`<Avatar
  name="Will"
  size={48}
  onClick={saySup}
